                            ...
                            @if (Session::has('topCart'))
                                ...
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
                                    <img class="img-fluid" src="{{asset('storage/product_images/'.$product['product_image'])}}" alt="{{$product['product_image']}}" />
                                </a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
                                    ...
                                    <td class="quantity-box">
                                        <form action="{{url('cart/updateqty', [$product['product_id']])}}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <input type="number" name="qty" size="4" value="{{$product['qty']}}" min="1" step="1" class="c-input-text qty text"> <br>
                                    ...
                                    <td class="total-pr">
                                        <p>$ {{number_format($product['product_price']*$product['qty'], 2)}}</p>
                                    </td>
                                    <td class="remove-pr">
            ...
            <div class="col-lg-4 col-sm-12">
                <div class="order-box">
                    ...
                    <div class="d-flex gr-total">
                        <h5>Total</h5>
                        <div class="ml-auto h5"> $ {{Session::has('cart') ? Session::get('cart')->totalPrice : 0}} </div>
                    </div>
                    <hr> </div>
            </div>
