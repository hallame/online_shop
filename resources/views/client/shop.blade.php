                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                        <div class="products-single fix">
                                            <div class="box-img-hover">
                                                ...
                                                <img src="{{asset('storage/product_images/'.$product->product_image)}}" class="img-fluid" alt="{{$product->product_image}}">
                                                <div class="mask-icon">
                                                    <ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                            <div class="why-text full-width">
                                                <h4>{{$product->product_name}}</h4>
                                                <h5> <del>{{$product->product_price}}</del> {{$product->product_discount_price}}</h5>
