                ...
                <ul class="cart-list">
                    @if (Session::has('topCart'))
                        @foreach (Session::get('topCart') as $product)
                            <li>
                                <a href="#" class="photo"><img src="{{asset('storage/product_images/'.$product['product_image'])}}" class="cart-thumb" alt="{{$product['product_price']}}"></a>
                                <h6><a href="#">{{$product['product_name']}} </a></h6>
                                <p>{{$product['qty']}}x - <span class="price">${{number_format($product['product_price'], 2)}}</span></p>
                            </li>
                        @endforeach
                    @endif
