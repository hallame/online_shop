              ...
              <form id="quickForm" action="{{url('admin/updateproduct/'.$product->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" value="{{$product->product_price}}" required name="product_price" class="form-control" id="exampleInputEmail1" placeholder="Enter product price" min="1">
                  </div>
                  <div class="form-group">
